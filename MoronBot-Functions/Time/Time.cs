        ...
        void commandReceived(object sender, BotMessage message)
        {
            ...
            if (message.ParameterList.Count > 0)
            {
                ...
                if (Double.TryParse(message.ParameterList[0], out offset))
                {
                    ...
                    {
                        FuncInterface.SendResponse(ResponseType.Say, "Offset too large, valid offsets are between -15 and +15.", message.ReplyTo);
                        return;
                    }
                }
            }
            ...
            FuncInterface.SendResponse(ResponseType.Say, "It's " + timeMessage + ".", message.ReplyTo);
            return;
        }
    }
}
